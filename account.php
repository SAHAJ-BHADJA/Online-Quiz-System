...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Us</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/tushar.jpg" width=100 height=100 alt="Us" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Bhut Tushar</a>
		<h4 style="font-family:'typo' ">bhuttushar2019@gmail.com</h4>
		<h4 style="font-family:'typo' ">PDEU</h4></div></div>
		</p>
      </div>
      <div class="modal-body">
        <p>
		<div class="row">
		<div class="col-md-4">
		 <img src="image/dhruv.jpeg" width=100 height=100 alt="Us" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Dhruv Bhanderi</a>
		<h4 style="font-family:'typo' ">dhruv.bhanderi@gmail.com</h4>
		<h4 style="font-family:'typo' ">PDEU</h4></div></div>
		</p>
      </div>
